...
> Releases are **unsigned** until we have a Developer ID / Windows code-signing setup. The binaries are produced by the GitHub Actions release workflow with no signing or notarization keys involved.
