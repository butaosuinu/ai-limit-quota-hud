...
- [x] Settings に "Updates" セクションが表示され、現在の version / 「今すぐ確認」/「起動時に確認」トグル / 状態バナーが動作する
- [x] 起動時 default-on で updater check が走り、Settings から OFF にすると startup network call がゼロになる
